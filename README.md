...
To predict the Song Popularity based on energy, acoustics, instrumentals, liveness, danceability, etc.  using evaluation metrics such as MAE or RMSE 
...
#RMSE is 21.61 with Linear via 10-fold cross validation method, however we recommend to perform Decision Tree and Random forest before conclusion. 
